    ...
    (function (Client) {
      var EmailPassword = function () {
        ...
        EmailPassword.Login = function (email, password, serviceCaller) {
          ...
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("EmailPassword/Login", 1, {
            email: email,
            password: password
          }).WithCallback(function (response) {
            response.Error == null && serviceCaller.SetSessionAuthenticated(EmailPassword.AuthenticationType(), response.Body.Results[0].Guid, response.Body.Results[0].SessionDateModified)
          })
        };
        EmailPassword.SetPassword = function (userGuid, newPassword, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("EmailPassword/SetPassword", 1, {
            userGuid: userGuid,
      ...
      var SecureCookie = function () {
        ...
        SecureCookie.Login = function (guid, passwordGuid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("SecureCookie/Login", 1, {
            guid: guid,
      ...
      var Facebook = function () {
        ...
        Facebook.Login = function (signedRequest, userAccessToken, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Facebook/Login", 1, {
      ...
      var AuthKey = function () {
        ...
        AuthKey.Create = function (name, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("AuthKey/Create", 0, {name: name})
        };
        AuthKey.Login = function (token, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("AuthKey/Login", 1, {token: token}).WithCallback(function (response) {
            if (response.Error == null) {
        ...
        AuthKey.Delete = function (name, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("AuthKey/Delete", 0, {name: name})
        };
        return AuthKey
      }();
      ...
      var OAuth = function () {
        ...
        OAuth.GetLoginEndPoint = function (callbackUrl, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("OAuth/GetLoginEndPoint", 0, {callbackUrl: callbackUrl}, true)
        };
        OAuth.ProcessLogin = function (callbackUrl, responseUrl, stateCode, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("OAuth/ProcessLogin", 0, {
    ...
    (function (Client) {
      var MetadataSchema = function () {
        ...
        MetadataSchema.Get = function (guid, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("MetadataSchema/Get", 0, {guid: guid}, true)
        };
        MetadataSchema.Create = function (name, schemaXml, guid, serviceCaller) {
          if (typeof guid === "undefined") guid = null;
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("MetadataSchema/Create", 1, {
            name: name,
            schemaXml: schemaXml,
            guid: guid
          }, true)
        ...
        MetadataSchema.Update = function (name, schemaXml, guid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("MetadataSchema/Update", 1, {
            name: name,
            schemaXml: schemaXml,
            guid: guid
          }, true)
        ...
        MetadataSchema.Delete = function (guid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("MetadataSchema/Delete", 0, {guid: guid}, true)
        };
        MetadataSchema.HasPermissionToMetadataSchema = function (guid, permission, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("MetadataSchema/HasPermissionToMetadataSchema", 0, {
            guid: guid,
      ...
      var Folder = function () {
        ...
        Folder.GetPermission = function (folderID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/GetPermission", 0, {folderID: folderID}, true)
        };
        Folder.SetPermission = function (userGuid, groupGuid, folderID, permission, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/SetPermission", 0, {
            userGuid: userGuid,
            groupGuid: groupGuid,
            folderID: folderID,
            permission: permission
        ...
        Folder.Get = function (id, folderTypeID, parentID, permission, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/Get", 0, {
            id: id,
        ...
        Folder.Delete = function (id, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/Delete", 0, {id: id}, true)
        };
        Folder.Update = function (id, newTitle, newParentID, newFolderTypeID, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/Update", 0, {
            id: id,
            newTitle: newTitle,
            newFolderTypeID: newFolderTypeID,
        ...
        Folder.Create = function (subscriptionGuid, title, parentID, folderTypeID, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Folder/Create", 0, {
      ...
      var FolderType = function () {
        ...
        FolderType.Get = function (name, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("FolderType/Get", 0, {name: name}, true)
        };
        return FolderType
      }();
      ...
      var Format = function () {
        ...
        Format.Get = function (name, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Format/Get", 0, {name: name}, true)
        };
        return Format
      }();
      ...
      var FormatType = function () {
        ...
        FormatType.Get = function (name, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("FormatType/Get", 0, {name: name}, true)
        };
        return FormatType
      }();
      ...
      var Language = function () {
        ...
        Language.Get = function (name, languageCode, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Language/Get", 0, {name: name, languageCode: languageCode}, true)
        };
        return Language
      }();
      ...
      var Link = function () {
        ...
        Link.Create = function (objectGuid, folderID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Link/Create", 0, {objectGuid: objectGuid, folderID: folderID}, true)
        };
        Link.Update = function (objectGuid, folderID, newFolderID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Link/Update", 0, {
        ...
        Link.Delete = function (objectGuid, folderID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Link/Delete", 0, {objectGuid: objectGuid, folderID: folderID}, true)
        };
        return Link
      }();
      Client.Link = Link;
      var Object = function () {
        ...
        Object.Create = function (guid, objectTypeID, folderID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Object/Create", 0, {
            guid: guid,
        ...
        Object.Get = function (objectGuids, accessPointGuid, includeMetadata, includeFiles, includeObjectRelations, includeFolders, includeAccessPoints, pageSize, pageIndex, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Object/Get", 0, {
        ...
        Object.SetPublishSettings = function (objectGuid, accessPointGuid, startDate, endDate, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Object/SetPublishSettings", 0, {
            objectGuid: objectGuid,
            accessPointGuid: accessPointGuid,
            startDate: startDate,
            endDate: endDate
      ...
      var ObjectRelation = function () {
        ...
        ObjectRelation.Set = function (object1Guid, object2Guid, objectRelationTypeID, sequence, metadataGuid, metadataSchemaGuid, languageCode, metadataXml, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectRelation/Set", 1, {
        ...
        ObjectRelation.Delete = function (object1Guid, object2Guid, objectRelationTypeID, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectRelation/Delete", 0, {
            object1Guid: object1Guid,
            object2Guid: object2Guid,
            objectRelationTypeID: objectRelationTypeID
          }, true)
      ...
      var ObjectRelationType = function () {
        ...
        ObjectRelationType.Get = function (value, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectRelationType/Get", 0, {value: value}, true)
        };
      ...
      var Metadata = function () {
        ...
        Metadata.Set = function (objectGuid, metadataSchemaGuid, languageCode, revisionID, metadataXml, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Metadata/Set", 1, {
            objectGuid: objectGuid,
            metadataSchemaGuid: metadataSchemaGuid,
            languageCode: languageCode,
      ...
      var ObjectType = function () {
        ...
        ObjectType.Get = function (serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectType/Get", 0, null, true)
        };
        ObjectType.Set = function (name, id, serviceCaller) {
          if (typeof id === "undefined") id = null;
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectType/Set", 0, {id: id, name: name}, true)
        };
        ObjectType.Delete = function (id, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ObjectType/Delete", 0, {id: id}, true)
        };
        return ObjectType
      }();
      ...
      var UserManagement = function () {
        ...
        UserManagement.GetUserFolder = function (userGuid, createIfMissing, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("UserManagement/GetUserFolder", 0, {
            userGuid: userGuid,
        ...
        UserManagement.GetUserObject = function (userGuid, createIfMissing, includeMetata, includeFiles, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("UserManagement/GetUserObject", 0, {
            userGuid: userGuid,
            createIfMissing: createIfMissing,
            includeMetata: includeMetata,
            includeFiles: includeFiles
          }, true)
        };
      ...
      var UserProfile = function () {
        ...
        UserProfile.Get = function (metadataSchemaGuid, userGuid, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("UserProfile/Get", 0, {
            metadataSchemaGuid: metadataSchemaGuid,
            userGuid: userGuid
          }, true)
        };
        UserProfile.Set = function (metadataSchemaGuid, metadata, userGuid, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("UserProfile/Set", 1, {
            metadataSchemaGuid: metadataSchemaGuid,
            metadata: metadata,
            userGuid: userGuid
          }, true)
    ...
    (function (Client) {
      var PortalClient = function () {
        function PortalClient(servicePath, clientGuid) {
          ...
          if (servicePath == null || servicePath == "" || typeof servicePath != "string") throw new Error("Parameter servicePath must be set to a valid path");
          if (servicePath.substr(servicePath.length - 1, 1) != "/") servicePath += "/";
        ...
        PortalClient.prototype.CallService = function (path, method, parameters, requiresSession, format) {
          ...
          if (requiresSession) parameters = this.AddSessionToParameters(parameters, path);
        ...
        PortalClient.prototype.AddSessionToParameters = function (parameters, path) {
          if (parameters == null) parameters = {};
          if (!this.HasSession()) throw new Error("Session is not acquired, but is required for: " + path);
        ...
        PortalClient.prototype.UpdateSession = function (session) {
          ...
          if (!hadSession && session != null) this._sessionAcquired.Raise(session); else if (session == null) this._authenticationType = null
        };
        PortalClient.prototype.SetSessionAuthenticated = function (type, userGuid, sessionDateModified) {
          this._authenticationType = type;
          if (type != null) {
            if (userGuid != null) this._currentSession.UserGuid = userGuid;
            if (sessionDateModified != null) this._currentSession.DateModified = sessionDateModified;
      ...
      var CallState = function () {
        ...
        CallState.prototype.Call = function (path, method, format, parameters) {
          var _this = this;
          if (typeof parameters === "undefined") parameters = null;
          if (this._call != null) throw new Error("Call can not be called multiple times");
          ...
          this._call.Call(function (response) {
            var recaller = function (resetSession) {
              ...
              if (resetSession) {
                ...
                for (var key in parameters) if (key == sessionName) {
            ...
            (_this._callHandler == null || _this._callHandler.ProcessResponse(response, recaller)) && _this._completed.Raise(response)
          }, function (progress) {
        ...
        CallState.prototype.WithCallback = function (callback, context) {
          ...
          if (context == null) this._completed.Add(callback); else this._completed.Add(function (response) {
        ...
        CallState.prototype.WithCallbackAndToken = function (callback, token, context) {
          if (typeof context === "undefined") context = null;
          if (context == null) this._completed.Add(function (response) {
            return callback(response, token)
          }); else this._completed.Add(function (response) {
        ...
        ServiceCall.prototype.Call = function (completeCallback, progressCallback, path, method, format, parameters) {
          ...
          if (window.FormData) this.CallWithXMLHttpRequest2Browser(path, method, parameters); else if (window.XMLHttpRequest) this.CallWithXMLHttpRequestBrowser(path, method, parameters); else if (window.XDomainRequest || window.ActiveXObject) this.CallWithOldIEBrowser(path, method, parameters); else throw new Error("Browser does not supper AJAX requests");
        };
        ServiceCall.prototype.CallWithXMLHttpRequest2Browser = function (path, method, parameters) {
          ...
          var data = null;
          if (method == 0) path += "?" + ServiceCall.CreateDataString(parameters); else {
            parameters = ServiceCall.ConvertDatesToCorrectFormat(ServiceCall.RemoveNullParameters(parameters));
            data = new FormData;
            for (var key in parameters) data.append(key, parameters[key])
          }
          ...
          this._request.open(method == 0 ? "GET" : "POST", path, true);
        ...
        ServiceCall.prototype.CallWithXMLHttpRequestBrowser = function (path, method, parameters) {
          ...
          this._request.open(method == 0 ? "GET" : "POST", path, true);
          method == 1 && this._request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
          this._request.send(data)
        };
        ServiceCall.prototype.CallWithOldIEBrowser = function (path, method, parameters) {
          ...
          this._request.open(method == 0 ? "GET" : "POST", path);
          this._request.send(data);
          this._request.responseText != "" && setTimeout(function () {
            return _this.ReportCompleted(_this._request.responseText)
          }, 1)
        };
        ServiceCall.prototype.RequestStateChange = function () {
          if (this._request.readyState != 4) return;
          if (this._request.status == 200) this.ReportCompleted(this._request.responseText); else this.ReportError()
        };
        ServiceCall.prototype.ReportCompleted = function (responseText) {
          ...
          if (response.Error != null && response.Error.Fullname == null) response.Error = null;
        ...
        ServiceCall.prototype.ReportProgressUpdate = function (bytesTransfered, totalBytes, totalBytesIsKnown) {
          ...
          this._progressCallback({
            ...
            TotalBytesIsKnown: totalBytesIsKnown
          })
        };
        ServiceCall.prototype.ReportError = function () {
          ...
          this._completeCallback({
            Header: null,
            Body: null,
            Error: {Fullname: "ServiceError", Message: "Service call failed", Stacktrace: null, InnerException: null}
          })
        };
        ...
        ServiceCall.ConvertDatesToCorrectFormat = function (parameters) {
          ...
          for (var key in parameters) {
            ...
            if (Client.Object.prototype.toString.call(value) === "[object Date]") parameters[key] = ServiceCall.ConvertDate(value)
          }
          return parameters
        };
        ServiceCall.RemoveNullParameters = function (parameters) {
          ...
          for (var key in parameters) {
            value = parameters[key];
            if (value == null) delete parameters[key]
          }
          return parameters
        };
        ...
        function Event(sender) {
          this.sender = sender;
          this._handlers = [];
          if (typeof sender === "undefined") throw new Error("Parameter sender must be set");
          this._sender = sender
        }

        Event.prototype.Add = function (handler) {
          if (handler == null) throw new Error("handler must be defined");
          this._handlers.push(handler)
        };
        Event.prototype.Remove = function (handler) {
          if (handler == null) throw new Error("handler must be defined");
          for (var i = 0; i < this._handlers.length; i++) if (this._handlers[i] === handler) {
            this._handlers.splice(i, 1);
            return
          }
        };
        Event.prototype.Raise = function (data) {
          for (var i = 0; i < this._handlers.length; i++) this._handlers[i].call(this._sender, data)
        };
        return Event
      }()
    })(Portal.Client || (Portal.Client = {}));
    ...
    (function (Client) {
      var Session = function () {
        ...
        Session.Create = function (serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Session/Create", 0, null, false).WithCallback(function (response) {
            response.Error == null && serviceCaller.UpdateSession(response.Body.Results[0])
          })
        };
      ...
      var User = function () {
        ...
        User.Create = function (guid, email, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("User/Create", 1, {guid: guid, email: email})
        };
        User.Update = function (guid, email, permissons, serviceCaller) {
          if (typeof permissons === "undefined") permissons = null;
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("User/Update", 1, {guid: guid, email: email, permissons: permissons}, true)
        };
        User.Delete = function (guid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("User/Delete", 0, {guid: guid})
        };
        User.Get = function (guid, groupGuid, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("User/Get", 0, {guid: guid, groupGuid: groupGuid})
        };
      ...
      var Group = function () {
        ...
        Group.Get = function (guid, userGuid, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/Get", 0, {guid: guid, userGuid: userGuid})
        };
        Group.Create = function (name, systemPermission, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/Create", 0, {name: name, systemPermission: systemPermission})
        };
        Group.Update = function (guid, newName, newSystemPermission, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/Update", 0, {
            guid: guid,
            newName: newName,
        ...
        Group.Delete = function (guid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/Delete", 0, {guid: guid})
        };
        Group.AddUser = function (guid, userGuid, permissions, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/AddUser", 0, {
            guid: guid,
            userGuid: userGuid,
        ...
        Group.RemoveUser = function (guid, userGuid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/RemoveUser", 0, {guid: guid, userGuid: userGuid})
        };
        Group.UpdateUserPermissions = function (guid, userGuid, permissions, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("Group/UpdateUserPermissions", 0, {
            guid: guid,
            userGuid: userGuid,
            permissions: permissions
          })
      ...
      var View = function () {
        ...
        View.Get = function (view, query, sort, filter, pageIndex, pageSize, serviceCaller) {
          ...
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("View/Get", 0, {
            view: view,
            query: query,
            sort: sort,
            filter: filter,
      ...
      var ClientSettings = function () {
        ...
        ClientSettings.Get = function (guid, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ClientSettings/Get", 0, {guid: guid})
        };
        ClientSettings.Set = function (guid, name, settings, serviceCaller) {
          if (typeof serviceCaller === "undefined") serviceCaller = null;
          if (serviceCaller == null) serviceCaller = ServiceCallerService.GetDefaultCaller();
          return serviceCaller.CallService("ClientSettings/Set", 1, {guid: guid, name: name, settings: settings})
        };
      ...
      function Initialize(servicePath, clientGUID, autoCreateSession) {
        ...
        autoCreateSession && Session.Create(client);
      ...
      var ServiceCallerService = function () {
        ...
        ServiceCallerService.GetDefaultCaller = function () {
          if (ServiceCallerService._defaultCaller == null) throw new Error("Default service caller not set");
      ...
      var SecureCookieHelper = function () {
        ...
        SecureCookieHelper.Login = function (callback, serviceCaller) {
          ...
          Client.SecureCookie.Login(login.Guid, login.PasswordGuid, serviceCaller).WithCallback(function (response) {
            ...
            } else callback != null && callback(false)
          })
        };
        SecureCookieHelper.Create = function (serviceCaller) {
          ...
          Client.SecureCookie.Create(serviceCaller).WithCallback(function (response) {
            response.Error == null && _this.SetCookie(response.Body.Results[0].Guid, response.Body.Results[0].PasswordGuid, _this.COOKIE_LIFE_TIME_DAYS)
          })
        };
        ...
        SecureCookieHelper.GetCookie = function () {
          ...
          var guidRegEx = /SecureCookieGuid\=(.+?)(?:;|$)/, passwordRegex = /SecureCookiePasswordGuid\=(.+?)(?:;|$)/,
            result = {Guid: "", PasswordGuid: ""}, match = guidRegEx.exec(cookie);
      ...
      var Wayf = function () {
        ...
        Wayf.LogIn = function (wayfServicePath, callbackUrl, serviceCaller) {
          ...
          return {
            ...
            Callback: function (status) {
              status == 0 && serviceCaller.SetSessionAuthenticated(Wayf.AuthenticationType())
            }
          }
        };
        Wayf.LogOut = function (wayfServicePath, callbackUrl, serviceCaller) {
          ...
          return {
            ...
            Callback: function (status) {
              status && serviceCaller.UpdateSession(null)
            }
          }
        };
        Wayf.BuildWayfServicePath = function (wayfServicePath, wayfMethod, callbackUrl, serviceCaller) {
          ...
          if (wayfServicePath.substr(wayfServicePath.length - 1, 1) != "/") wayfServicePath += "/";
...
module.exports = CHAOS.Portal.Client;
